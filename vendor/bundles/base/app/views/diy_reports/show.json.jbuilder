...
json.service_in_params @diy_report.diy_selection.service_in_params, :id, :resource_type, :resource_id, :name, :description, :rank if @diy_report.diy_selection
json.service_out_params @diy_report.diy_selection.service_out_params, :id, :resource_type, :resource_id, :name, :description, :rank if @diy_report.diy_selection

class Entity < ActiveRecord::Base
  ...
  def self.setup(entity_class, options={}, &block)
    ...
    setup_helper.columns.each do |c|
      ...
      if(column.list_rank > 0 && !['id', 'domain_id', 'creator_id', 'updater_id', 'created_at', 'updated_at'].include?(column.name))
  ...
  # setup helper
  class SetupHelper
    attr_accessor :list_columns, :search_columns, :sort_columns, :reverse_sort_columns, :editable_columns, :columns, :properties

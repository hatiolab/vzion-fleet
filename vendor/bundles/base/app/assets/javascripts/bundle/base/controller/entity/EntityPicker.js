Ext.define('Base.controller.entity.EntityPicker', {
	extend : 'Ext.app.Controller',
	
	views : ['Base.view.entity.EntityPicker'],
	...
	onShow : function(picker) {
		...
		if(picker.host.storeClass) {
			...
			url = (url.lastIndexOf('diy_selection', 0) === -1) ?
			('diy_selections/' + picker.host.customSelectionUrl + '/query.json') : url;

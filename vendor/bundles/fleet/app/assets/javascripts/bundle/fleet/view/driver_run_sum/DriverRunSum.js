Ext.define('Fleet.view.driver_run_sum.DriverRunSum', {
	...
	columns : [
		...
		{ header : T('label.run_time'), dataIndex : 'run_time', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 80, editor : { xtype : 'numberfield' } },
		{ header : T('label.run_dist'), dataIndex : 'run_dist', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 80, editor : { xtype : 'numberfield' } },
		{ header : T('label.consmpt'), dataIndex : 'consmpt', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 100, editor : { xtype : 'numberfield' } },
		{ header : T('label.co2_emss'), dataIndex : 'co2_emss', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 100, editor : { xtype : 'numberfield' } },
		...
		{ header : T('label.eco_drv_time'), dataIndex : 'eco_drv_time', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 120, editor : { xtype : 'numberfield' } },
		{ header : T('label.ovr_spd_time'), dataIndex : 'ovr_spd_time', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 120, editor : { xtype : 'numberfield' } },
		{ header : T('label.idle_time'), dataIndex : 'idle_time', xtype : 'numbercolumn', format : T('format.number'), align : 'right', width : 80, editor : { xtype : 'numberfield' } },

Ext.define('Fleet.view.vehicle_checkin.VehicleCheckin', {
	...
	columns : [
		...
		{ header : T('label.date'), dataIndex : 'run_date', xtype : 'datecolumn', format : T('format.date'), width : 80, align : 'center', editor : { xtype : 'datefield', format : T('format.date') } },
		{ header : T('label.start_time'), dataIndex : 'start_time', width : 130, editor : { xtype : 'datefield', format : T('format.datetime') } },
		{ header : T('label.run_dist'), dataIndex : 'run_dist', align : 'right', width : 105, editor : { xtype : 'numberfield' } },
	...
	dockedItems: [ {
		...
		xtype: 'controlbar',
		items: ['simulation', 'daily_summary', 'monthly_summary', '->', 'import', 'export', 'add', 'save', 'delete']
	} ]
});
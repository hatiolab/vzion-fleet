Ext.define('Fleet.view.task.TaskForm', {
	...
	items : [
		...
		{ xtype : 'datefield', name : 'start_date', fieldLabel : T('label.x_date', {x : T('label.start')}), format : T('format.date'), submitFormat : 'Y-m-d' },
		{ xtype : 'datefield', name : 'end_date', fieldLabel : T('label.x_date', {x : T('label.end')}), format : T('format.date'), submitFormat : 'Y-m-d' },

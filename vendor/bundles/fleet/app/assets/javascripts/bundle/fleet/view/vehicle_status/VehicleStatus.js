Ext.define('Fleet.view.vehicle_status.VehicleStatus', {
	...
	columns : [
		...
		{ header : T('label.total_dist'), dataIndex : 'total_dist', xtype : 'numbercolumn', format : T('format.number'), width : 90, align : 'right', editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.total_runtime'), dataIndex : 'total_runtime', xtype : 'numbercolumn', format : T('format.number'), width : 105, align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.remain_fuel'), dataIndex : 'remain_fuel', align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.official_effcc'), dataIndex : 'official_effcc', align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.avg_effcc'), dataIndex : 'avg_effcc', width : 85, align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.eco_index'), dataIndex : 'eco_index', width : 85, align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },
		{ header : T('label.eco_run_rate'), dataIndex : 'eco_run_rate', align : 'right' , editor : { xtype : 'numberfield', minValue : 0 } },

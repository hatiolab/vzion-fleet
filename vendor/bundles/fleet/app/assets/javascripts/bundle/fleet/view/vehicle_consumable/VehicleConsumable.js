Ext.define('Fleet.view.vehicle_consumable.VehicleConsumable', {
	...
	columns : [
		...
		{ header : T('label.description'), dataIndex : 'description' , editor : { xtype : 'textfield' } },
		{ header : T('label.status'), dataIndex : 'status', width : 85, editor : { xtype : 'codecombo', commonCode : 'HEALTH_STATUS' } },
		{ header : T('label.health_rate'), dataIndex : 'health_rate', width : 90, align : 'right' , editor : { xtype : 'numberfield' } },
		...
		{ header : T('label.next_repl_mile'), dataIndex : 'next_repl_mile', align : 'right', width : 140, editor : { xtype : 'numberfield' } },

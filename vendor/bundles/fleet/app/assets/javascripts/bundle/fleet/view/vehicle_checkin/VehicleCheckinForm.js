	...
	items : [{
		...
		items : [{
			...
			items : [
				...
				{ xtype : 'datefield', name : 'run_date', fieldLabel : T('label.run_date'), format : T('format.date'), submitFormat : T('format.submitDate') },
				{ xtype : 'datefield', name : 'start_time', fieldLabel : T('label.start_time'), format : T('format.datetime'), submitFormat : T('format.submitDatetime') },

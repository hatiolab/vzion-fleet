Ext.define('Fleet.view.vehicle.VehicleRepair', {
	...
	columns : [ 
		...
		{ header : T('label.repair_time'), dataIndex : 'repair_time', align : 'right', width : 90 , editor : { xtype : 'numberfield' } },
		...
		{ header : T('label.repair_mileage'), dataIndex : 'repair_mileage', align : 'right', width : 110 , editor : { xtype : 'numberfield' } },
		...
		{ header : T('label.cost'), dataIndex : 'cost', align : 'right', width : 70 , editor : { xtype : 'numberfield' } },

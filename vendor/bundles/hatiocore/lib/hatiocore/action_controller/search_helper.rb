module Hatio
  module SearchHelper
    ...
    def search_filter resource, options = {}
      ...
      if(entity)
        ...
        if(search_param_type == 1)
          conditions = build_conditions_by_search_params(table_name, search_params, entity_columns)
        elsif(search_param_type == 2)
          conditions = build_conditions_by_filters(table_name, search_params, entity_columns)
        end
    ...
    #
    def build_conditions_by_filters(table_name, filter_str, entity_columns)
    ...
    #
    def build_conditions_by_search_params(table_name, search_params, entity_columns)

Ext.define('wd.controller.Main', {
    ...
    config: {
        ...
        control: {
            '#homeCard toolbar[docked=bottom] button[action=byRegion]': {
                tap: 'byRegion'
            },
            '#homeCard toolbar[docked=bottom] button[action=byIndicator]': {
                tap: 'byIndicator'
            },
            homeList: {
                itemtap: 'goCurated'
        ...
        routes: {
            ...
            'assets/app-touch/data/:country/:indicator': 'showData'
        }
    },
    ...
    launch: function () {
        // TODO: remove this when touch team fixed the bug in control.
        var itemComp = this.getItemComp();
        itemComp.on('show', this.showCompare, this);

        var itemInfo = this.getItemInfo();
        itemInfo.on('show', this.showInfo, this);
    },

T({
	...
	report : {
		...
		eco_index_by_vehicles : '차량별 에코 지수',
		eco_index_by_drivers : '운전자별 에코 지수',
		eco_drv_time_by_vehicles : '차량별 경제운전시간',
		eco_drv_time_by_drivers : '운전자별 경제운전시간',
		idle_time_by_vehicles : '차량별 공회전시간',
		idle_time_by_drivers : '운전자별 공회전시간',
		ovr_spd_time_by_vehicles : '차량별 과속시간',
		ovr_spd_time_by_drivers : '운전자별 과속시간',
		sud_accel_cnt_by_vehicles : '차량별 급가속시간',
		sud_accel_cnt_by_drivers : '운전자별 급가속시간',
		sud_brake_cnt_by_vehicles : '차량별 급감속시간',
		...
		maint_trend : '정비 추이',
		driving_trend : '주행 추이',
		eco_driving_trend : 'Eco Driving 추이',
        co2emss_ecoindex : 'Co2배출량-Eco지수 관계',
	...
	label : {
		...
		total_run_time : '총 주행시간',
		eco_index : '에코 지수',
		eco_run_rate : '경제 주행 비율',
		official_effcc : '공인 연비',
		avg_effcc : '평균 연비',
		avg_consmpt : '평균 연료소모량',

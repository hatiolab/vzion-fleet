Ext.define('FleetTouch.view.report.DailyReport3', {
	extend : 'Ext.Panel',
	...
	refresh : function() {
		var self = this;
		Ext.Ajax.request({
			url: window.location.pathname.indexOf(contextPath) === 0 ? 'diy_services/FleetDailyDrivingHabit/shoot.json' : 'assets/app-touch/data/daily_report3.json',
			method : 'POST',
			// params : { id : 'daily_driving_habit' },

Ext.define('FleetTouch.view.monitor.Info', {
    extend: 'Ext.Panel',
            ...
            items: [{
                ...
                items: [{
		            ...
		            },
					{
		                ...
		                data: null,
		                tpl: [
		                '<div class="infoID {status}">{name} ({description})</div>',
						'<tpl if="driver_id">',
		                '<div class="infoText">'+ T('label.driver') +' : {driver_name} ({driver_desc})</div>',
						'<tpl else>',
    ...
    setVehicle: function(vehicle) {
		...
		if(driverRecord) {
			...
			vehicle.set('driver_desc', driverRecord.get('description'));
		}

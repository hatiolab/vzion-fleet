...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.device.Purchases.Product": "assets/app-touch/touch/src/device/purchases/Sencha.js",
  "Ext.device.filesystem.DirectoryEntry": "assets/app-touch/touch/src/device/filesystem/HTML5.js",
  "Ext.device.filesystem.Entry": "assets/app-touch/touch/src/device/filesystem/HTML5.js",
  "Ext.device.filesystem.FileEntry": "assets/app-touch/touch/src/device/filesystem/HTML5.js",
  "Ext.device.filesystem.FileSystem": "assets/app-touch/touch/src/device/filesystem/HTML5.js",
  "Ext.device.purchases.Purchase": "assets/app-touch/touch/src/device/purchases/Sencha.js",
  "Ext.device.sqlite.Database": "assets/app-touch/touch/src/device/sqlite/Sencha.js",
  "Ext.device.sqlite.SQLResultSet": "assets/app-touch/touch/src/device/sqlite/Sencha.js",
  "Ext.device.sqlite.SQLResultSetRowList": "assets/app-touch/touch/src/device/sqlite/Sencha.js",
  "Ext.device.sqlite.SQLTransaction": "assets/app-touch/touch/src/device/sqlite/Sencha.js",
  "Ext.draw.engine.SvgContext.Gradient": "assets/app-touch/touch/src/draw/engine/SvgContext.js",
  "FleetTouch": "assets/app-touch/app.js",
  "FleetTouch.mixin.Setting.Inner": "assets/app-touch/app/mixin/Setting.js",
  "FleetTouch.mixin.Setting.Model": "assets/app-touch/app/mixin/Setting.js",
  "FleetTouch.view.nav.NavComm": "assets/app-touch/app/view/Nav/NavComm.js",
  "FleetTouch.view.nav.NavDriver": "assets/app-touch/app/view/Nav/NavDriver.js",
  "FleetTouch.view.nav.NavFav": "assets/app-touch/app/view/Nav/NavFav.js",
  "FleetTouch.view.nav.NavMenu": "assets/app-touch/app/view/Nav/NavMenu.js",
  "FleetTouch.view.nav.NavNoti": "assets/app-touch/app/view/Nav/NavNoti.js",
  "FleetTouch.view.nav.NavReport": "assets/app-touch/app/view/Nav/NavReport.js",
  "FleetTouch.view.nav.NavVehicle": "assets/app-touch/app/view/Nav/NavVehicle.js"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "FleetTouch": [],
  "FleetTouch.controller.Main": [],
  "FleetTouch.controller.Nav": [],
  "FleetTouch.controller.Report": [],
  "FleetTouch.controller.monitor.Info": [],
  "FleetTouch.controller.monitor.Track": [],
  "FleetTouch.mixin.Label": [],
  "FleetTouch.mixin.Map": [],
  "FleetTouch.mixin.Nav": [],
  "FleetTouch.mixin.Setting": [],
  "FleetTouch.mixin.Setting.Inner": [],
  "FleetTouch.mixin.Setting.Model": [],
  "FleetTouch.mixin.SubItem": [],
  "FleetTouch.mixin.User": [],
  "FleetTouch.model.Menu": [],
  "FleetTouch.store.DriverBriefStore": [],
  "FleetTouch.store.DriverGroupStore": [],
  "FleetTouch.store.DriverRunStore": [],
  "FleetTouch.store.DriverStore": [],
  "FleetTouch.store.DriverSummaryStore": [],
  "FleetTouch.store.IncidentByVehicleStore": [],
  "FleetTouch.store.IncidentLogStore": [],
  "FleetTouch.store.RecentIncidentStore": [],
  "FleetTouch.store.TrackByVehicleStore": [],
  "FleetTouch.store.TrackStore": [],
  "FleetTouch.store.UserStore": [],
  "FleetTouch.store.VehicleConsumableStore": [],
  "FleetTouch.store.VehicleFilteredStore": [],
  "FleetTouch.store.VehicleGroupStore": [],
  "FleetTouch.store.VehicleMapStore": [],
  "FleetTouch.store.VehicleRepairStore": [],
  "FleetTouch.store.VehicleRunStore": [],
  "FleetTouch.store.VehicleStore": [],
  "FleetTouch.store.VehicleSummaryStore": [],
  "FleetTouch.store.YearStore": [],
  "FleetTouch.view.Content": [],
  "FleetTouch.view.Header": [],
  "FleetTouch.view.Main": [],
  "FleetTouch.view.Nav": [],
  "FleetTouch.view.Setting": [],
  ...
  "FleetTouch.view.report.AreaChart": [],
  "FleetTouch.view.report.BarChart": [],
  "FleetTouch.view.report.ColumnChart": [],
  ...
  "FleetTouch.view.vehicle.Vehicle": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "FleetTouch.view.chart.driver.EcoRadar": [
    "widget.chart_d_eco_radar"
  ],
  "FleetTouch.view.chart.driver.Running": [
    "widget.chart_d_running"
  ],
  "FleetTouch.view.chart.vehicle.Accel": [
    "widget.chart_v_accel"
  ],
  "FleetTouch.view.chart.vehicle.Consumable": [
    "widget.chart_v_consumable"
  ],
  "FleetTouch.view.chart.vehicle.EcoRadar": [
    "widget.chart_v_eco_radar"
  ],
  "FleetTouch.view.chart.vehicle.Mtbf": [
    "widget.vehicle_chart_mtbf"
  ],
  "FleetTouch.view.chart.vehicle.Mttr": [
    "widget.vehicle_chart_mttr"
  ],
  "FleetTouch.view.chart.vehicle.Running": [
    "widget.chart_v_running"
  ],
  "FleetTouch.view.driver.Driver": [
    "widget.driver"
  ],
  "FleetTouch.view.driver.Summary": [
    "widget.driver_summary"
  ],
  "FleetTouch.view.monitor.Incident": [
    "widget.monitor_incident"
  ],
  "FleetTouch.view.monitor.Info": [
    "widget.monitor_info"
  ],
  ...
  "FleetTouch.view.report.DailyReport": [
    "widget.rpt_daily_driving"
  ],
  "FleetTouch.view.report.DailyReport2": [
    "widget.rpt_daily_driving2"
  ],
  "FleetTouch.view.report.DailyReport3": [
    "widget.rpt_daily_habit"
  ],
  "FleetTouch.view.report.DrivingReport": [
    "widget.rpt_driving_trend"
  ],
  "FleetTouch.view.report.EcoDrivingHabitReport": [
    "widget.rpt_habit_ecoindex"
  ],
  "FleetTouch.view.report.EcoDrivingReport": [
    "widget.rpt_eco_driving_trend"
  ],
  "FleetTouch.view.report.EffccConsumptionReport": [
    "widget.rpt_effcc_consmpt"
  ],
  "FleetTouch.view.report.EfficiencyReport": [
    "widget.rpt_effcc_trend"
  ],
  "FleetTouch.view.report.LineChart": [
    "widget.rpt_line"
  ],
  "FleetTouch.view.report.MaintTrendReport": [
    "widget.rpt_maint_trend"
  ],
  "FleetTouch.view.report.MonthlyReport": [
    "widget.rpt_monthly_driving"
  ],
  "FleetTouch.view.report.PieChart": [
    "widget.rpt_pie"
  ],
  "FleetTouch.view.report.VehicleHealth": [
    "widget.rpt_vehicle_health"
  ],
  "FleetTouch.view.vehicle.Repair": [
    "widget.vehicle_repair"
  ],
  "FleetTouch.view.vehicle.RepairHistory": [
    "widget.vehicle_repair_history"
  ],
  "FleetTouch.view.vehicle.RepairOverview": [
    "widget.vehicle_repair_overview"
  ],
  "FleetTouch.view.vehicle.Summary": [
    "widget.vehicle_summary"
  ],
  "FleetTouch.view.vehicle.Vehicle": [
    "widget.vehicle"
  ]
